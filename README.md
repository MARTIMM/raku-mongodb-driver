...
* [*] create. Happens implicitly after inserting data into a collection.
* [*] drop() Drop a database.
* [*] list_databases(). Returns database statistics.
* [*] database_names(). Returns a list of database names.
* [*] get_last_error(). Get error status from last operation
...
### Query and Write Operation Commands
  ...
  * Cursors
    ...
    * [.] limit()
    * [.] skip()
    * [*] count(), Count docs after find using limit and skip.

  * [*] insert(). Insert documents in a collection.
  
  * [*] update(). Update documents in a collection.
    * [*] upsert
    * [*] update commands like $inc and $push
  ...
  * [*] find_one(). Search and return only one document.
    * [*] %criteria (Search criteria)
    * [*] %projection (Field selection)
...
* [*] Convert all strings to UTF-8. This is inherent to perl6. Everything is
      UTF8 and conversion to buffers is done using encode and decode.
* [*] Automatic _id generation. See BSON module.
...
* [*] list_databases. Returns a document that lists all databases and returns basic database statistics.
