...
=head1 Synopsis
  ...
  if $client.nbr-servers {
    my MongoDB::Database $d = $client.database('my_db');
    my MongoDB::Collection $c = $client.collection('my_db.mcll')
  }
...
can be retrieved. I<This call is for internal use only>.


=head2 method take-out-server
