...
and s# mongos servers.
Port numbers are irrelevant here. When two servers in a replica set R1 are used,
the table shows 'r1R1, r2R1, R1' and the uri could be something like
