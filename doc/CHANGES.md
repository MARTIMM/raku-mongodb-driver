...
* 0.39.0
  * Changes in setup of tests using a wrapper. It is now possible to start a set of tests with a particular server setup. With this older server versions can be tested.
  * Mongod server version 2.6.* supported
* 0.38.3
  * Log fixes
